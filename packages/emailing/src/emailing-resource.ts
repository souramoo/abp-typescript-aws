...
/** Port of `EmailingResource` ("AbpEmailing"). */
@LocalizationResourceName("AbpEmailing")
export class EmailingResource {}

/** Port of `Volo/Abp/Emailing/Localization/en.json`. */
export const abpEmailingEn: JsonLocalizationFile = {
  culture: "en",
  texts: {
