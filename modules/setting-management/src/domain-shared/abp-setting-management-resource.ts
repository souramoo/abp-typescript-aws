...
/** Port of `AbpSettingManagementResource` ("AbpSettingManagement"). */
@LocalizationResourceName("AbpSettingManagement")
export class AbpSettingManagementResource {}

/** Port of `Volo/Abp/SettingManagement/Localization/Resources/AbpSettingManagement/en.json`. */
export const abpSettingManagementEn: JsonLocalizationFile = {
  culture: "en",
  texts: {
    Settings: "Settings",
